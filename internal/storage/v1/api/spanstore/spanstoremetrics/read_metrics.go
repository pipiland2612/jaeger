...
func NewReaderDecorator(spanReader spanstore.Reader, metricsFactory metrics.Factory) *ReadMetricsDecorator {
	return &ReadMetricsDecorator{
		...
		findTracesMetrics:    buildQueryMetrics("err", metricsFactory),
		findTraceIDsMetrics:  buildQueryMetrics("err", metricsFactory),
		getTraceMetrics:      buildQueryMetrics("err", metricsFactory),
		getServicesMetrics:   buildQueryMetrics("err", metricsFactory),
		getOperationsMetrics: buildQueryMetrics("err", metricsFactory),
	}
}
